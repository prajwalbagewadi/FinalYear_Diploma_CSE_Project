...
public class HeristicOptOnDemandResrvBaseMdl {
	...
	public static void main(String[] args) {
		...
		try {
			...
			vmList = createVms(userid, vmsStartlNumber,0);
			...
			Log.printLine(String.format("Total Cost: %.8f $", cost));
		...
		Log.printLine("Algo Execution finished!");
	}
